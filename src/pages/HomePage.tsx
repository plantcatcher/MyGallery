    ...
    <div className="max-w-7xl mx-auto px-6 md:px-12 pb-24">
      ...
      <section className="py-24 md:py-40 space-y-12 text-center md:text-left">
        <div className="space-y-4">
          ...
          >
            在光影的<br />
            <span className="text-muted-foreground/30 italic hover:text-accent/50 transition-colors duration-1000">缝隙中</span>
            <br />
            寻找永恒。
          </motion.h1>
        </div>
            ...
            <div className="flex justify-center">
              <Link to="/gallery">
                <Button variant="outline" className="rounded-full px-8 font-serif italic tracking-widest">
                  开启完整画廊 <ChevronRight className="w-4 h-4 ml-2" />
                </Button>
              </Link>
            </div>
          </div>
        ...
        {viewMode === "timeline" && (
          <div className="space-y-16">
            ...
            <div className="flex justify-center">
              <Link to="/gallery">
                <Button variant="outline" className="rounded-full px-8 font-serif italic tracking-widest">
                  回溯完整光影 <ChevronRight className="w-4 h-4 ml-2" />
                </Button>
              </Link>
            </div>
          </div>
          ...
          <div className="space-y-16">
            ...
            {!showAllProjects && projects.length > 2 && (
              <div className="flex justify-center">
                ...
                >
                  展开所有叙事 <ChevronRight className="w-4 h-4 ml-2 rotate-90" />
                </Button>
              </div>
            )}
          </div>
            ...
            <div className="space-y-4">
              ...
              <div className="pt-4">
                <span className="text-[10px] text-white/50 uppercase tracking-[0.2em] flex items-center">
                  {isOpen ? "收起系列" : "探索系列"} ({projectPhotos.length} 张照片)
